...
// background layout
var groupSvgOneFirst = "M313.361 1C168.283 85.7851 29.5706 290.463 51.3611 374.128C58.6111 401.965 82.7319 421.163 84.3611 448.999C86.5724 486.782 27.2993 470.435 44.8611 552.187C92.3766 773.377 -20.9259 804.996 4.8732 892.403C30.6723 979.81 75.6848 1021.74 118.907 1058.45C153.484 1087.82 267.235 1132.12 313.361 1097.45";
var groupSvgOneLast = "M313.361 1C168.283 85.7851 23.0706 337.335 44.8611 421C52.1111 448.837 87.3708 466.663 89 494.5C91.2113 532.283 27.2993 500.248 44.8611 582C92.3766 803.19 -20.9259 804.996 4.8732 892.403C30.6723 979.81 75.6848 1021.74 118.907 1058.45C153.484 1087.82 267.235 1132.12 313.361 1097.45";
var groupSvgTwooFirst = "M314.361 0.451782C169.451 85.2753 31.0957 294.944 52.861 378.647C60.1026 406.496 83.9984 420.805 85.6257 448.654C87.8345 486.454 28.6299 470.1 46.1714 551.889C93.632 773.179 -20.9083 806.659 4.86102 894.106C30.6303 981.553 76.9595 1021.65 120.131 1058.38C154.669 1087.76 268.289 1132.08 314.361 1097.4";
var groupSvgTwoLast = "M314.361 0.451782C169.451 85.2753 23.2347 337.297 45 421C52.2416 448.849 88.3727 461.651 90 489.5C92.2088 527.3 27.4585 491.711 45 573.5C92.4606 794.79 -20.9081 806.659 4.86114 894.106C30.6304 981.553 76.9596 1021.65 120.132 1058.38C154.669 1087.76 268.289 1132.08 314.361 1097.4";
var groupSvgThreeFirst = "M313.689 0.371582C168.778 85.1951 30.4233 294.863 52.1886 378.567C59.4302 406.416 83.2338 421.749 84.8611 449.598C87.0699 487.398 27.3196 470.517 44.8611 552.306C92.4169 774.04 -20.9082 806.579 4.86111 894.026C30.6304 981.473 76.2871 1021.57 119.459 1058.3C153.997 1087.68 267.616 1132 313.689 1097.32";
var groupSvgThreeLast = "M313.692 1C168.781 85.8235 17.7347 332.297 39.5 416C46.7416 443.849 83.8727 460.151 85.5001 488C87.7088 525.8 23.4585 486.711 41 568.5C88.5558 790.234 -20.9051 807.207 4.86421 894.654C30.6335 982.101 76.2902 1022.2 119.462 1058.93C154 1088.31 267.619 1132.63 313.692 1097.94";
var groupSvg = document.querySelectorAll('.group-svg');

for (var i = 0; i < groupSvg.length; i++) {
  groupSvg[i].style.left = String(i * 7.1) + 'px';
}

;
console.log(groupSvg);
document.querySelector('.header-article-title').addEventListener('click', function () {
  var tl = _animeEs.default.timeline();

  tl.add({
    targets: '.group-svg-one path',
    d: [{
      value: groupSvgOneLast
    }],
    easing: 'easeOutExpo',
    delay: _animeEs.default.stagger(20),
    duration: 500
  }).add({
    targets: '.group-svg-two path',
    d: [{
      value: groupSvgTwoLast
    }],
    easing: 'easeOutExpo',
    delay: _animeEs.default.stagger(20)
  }, 400).add({
    targets: '.group-svg-three path',
    d: [{
      value: groupSvgThreeLast
    }],
    easing: 'easeOutExpo',
    delay: _animeEs.default.stagger(20)
  }, 400);
});
},{"@dogstudio/highway":"node_modules/@dogstudio/highway/build/highway.module.js","animejs/lib/anime.es.js":"node_modules/animejs/lib/anime.es.js"}],"../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
